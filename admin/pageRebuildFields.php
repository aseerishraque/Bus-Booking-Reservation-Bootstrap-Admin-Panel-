	...
	*/
	...
	$schema = array(   
		'buses' => array(   
			...
			'number' => array('appgini' => 'VARCHAR(40) ')
		),
		'seats' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
		...
		'availability' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'bus' => array('appgini' => 'INT unsigned '),
			'route' => array('appgini' => 'INT unsigned '),
			'amount' => array('appgini' => 'INT unsigned '),
		...
		'bookings' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'id_number' => array('appgini' => 'INT unsigned '),
			'fullname' => array('appgini' => 'INT unsigned '),
			'phone' => array('appgini' => 'INT unsigned '),
			'bus' => array('appgini' => 'INT unsigned '),
			'seat' => array('appgini' => 'INT unsigned '),
			'amount' => array('appgini' => 'INT unsigned '),
			'date' => array('appgini' => 'INT unsigned default \'1\' '),
			'time' => array('appgini' => 'INT unsigned '),
			'luggage' => array('appgini' => 'VARCHAR(40) '),
			'date_booked' => array('appgini' => 'DATE ')
		),
		'routes' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'name' => array('appgini' => 'VARCHAR(40) '),
			'time' => array('appgini' => 'VARCHAR(40) '),
			'amount' => array('appgini' => 'VARCHAR(40) ')
		),
		'customers' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'fullname' => array('appgini' => 'VARCHAR(40) '),
			'phone' => array('appgini' => 'VARCHAR(40) '),
			'id_number' => array('appgini' => 'VARCHAR(40) ')
		)
	);
