		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'buses' => array(
					'Caption' => 'Buses',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/yellow_submarine.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'seats' => array(
				...
				'bookings' => array(
					'Caption' => 'Bookings',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/accordion.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'routes' => array(
					'Caption' => 'Routes',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/routing_go_right.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'customers' => array(
	...
	*/
	...
	function app_datetime_format($destination = 'php', $datetime = 'd'){
		switch(strtolower($destination)){
			case 'mysql':
				$date = '%m/%d/%Y';
				$time = '%h:%i:%s %p'; // or %H w/o %p
				break;
			case 'moment':
				$date = 'MM/DD/Y';
				$time = 'hh:mm:ss A'; // or HH w/o A
				break;
			default: // php
				$date = 'm/d/Y';
				$time = 'h:i:s A'; // or H w/o A
		}
